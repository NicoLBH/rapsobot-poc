...
const ASSIST_LLM_URL_PROD = "https://nicolbh.app.n8n.cloud/webhook/rapsobot-poc-assistant";
...
function ensureAssistantOverlayDom() {
  ...
  function hasPendingAssistantActions() {
    const store = loadAssistStore();
    const bucket = ensureAssistRunBucket(store);
    const p = bucket.pending_actions || null;
  ...
  function clearPendingAssistantActions() { setPendingAssistantActions(null); }
