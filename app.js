...
function renderDetails(opts) {
  ...
  const selSid = (opts.selection && ("sid" in opts.selection)) ? opts.selection.sid : (target === "drill" ? uiState.selectedSituationId : selSid);
  const selPid = (opts.selection && ("pid" in opts.selection)) ? opts.selection.pid : (target === "drill" ? uiState.selectedProblemId : selPid);
  const selAid = (opts.selection && ("aid" in opts.selection)) ? opts.selection.aid : (target === "drill" ? uiState.selectedAvisId : selAid);
