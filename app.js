...
function renderDetails() {
  ...
  const buildSubIssuesForSituation = (sit) => {
    ...
    const metaHtml = `<div class="subissues-counts subissues-counts--problems"><span class="subissues-count-closed mono">${closedPb}</span>/<span class="subissues-count-total mono">${totalPb}</span></div>`;
